...
DefinitionBlock ("iASLMrQ9dY.aml", "DSDT", 1, "DELL  ", "CL09   ", 0x00000000)
{
    ...
    OperationRegion (OGNS, SystemMemory, 0x9AFBA018, 0x101A)
        ...
        Device (PCI0)
        {
            ...
            Device (PEG0)
            {
                ...
                Device (PEGP)
                {
                    ...
                    OperationRegion (VBOR, SystemMemory, 0x9AFA2018, 0xE604)
                    ...
                    OperationRegion (SGOP, SystemMemory, 0x9AFBDD18, 0x4C)
                    ...
                    OperationRegion (NOPR, SystemMemory, 0x9AFA0018, 0x1014)
