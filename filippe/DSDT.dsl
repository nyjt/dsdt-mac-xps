 ...
 * 
 * Disassembly of DSDT.aml, Sat Aug 30 00:50:23 2014
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000B8F8 (47352)
...
DefinitionBlock ("DSDT.aml", "DSDT", 1, "DELL  ", "CL09   ", 0x00000000)
{
    ...
    OperationRegion (OGNS, SystemMemory, 0x9AFAA018, 0x101A)
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (PEG0)
            {
                ...
                OperationRegion (RPCX, SystemMemory, PEGP.XBAS, 0x9000)
                ...
                Device (PEGP)
                {
                    ...
                    OperationRegion (VBOR, SystemMemory, 0x9AF92018, 0xE604)
                    ...
                    OperationRegion (SGOP, SystemMemory, 0x9AFBDD98, 0x4C)
                    ...
                    OperationRegion (NOPR, SystemMemory, 0x9AF90018, 0x1014)
                    ...
                    Device (DD01)
                    {
                        ...
                        {
                            Return (^^^^IGPU.DD01._ADR ())
                        }

                        Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
                        {
                            Return (^^^^IGPU.DD01._DCS ())
                        }

                        Method (_DGS, 0, NotSerialized)  // _DGS: Display Graphics State
                        {
                            Return (^^^^IGPU.DD01._DGS ())
                        }
                    ...
                    Device (DD02)
                    {
                        Method (_ADR, 0, Serialized)  // _ADR: Address
                        {
                            Return (^^^^IGPU.DD02._ADR ())
                        }

                        Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
                        {
                            Return (^^^^IGPU.DD02._DCS ())
                        }

                        Method (_DGS, 0, NotSerialized)  // _DGS: Display Graphics State
                        {
                            Return (^^^^IGPU.DD02._DGS ())
                        }
                        ...
                        {
                            Return (^^^^IGPU.DD02._BCL ())
                        }

                        Method (_BQC, 0, NotSerialized)  // _BQC: Brightness Query Current
                        {
                            Return (^^^^IGPU.DD02._BQC)
                        }
                    }
                    ...
                    Device (DD03)
                    {
                        Method (_ADR, 0, Serialized)  // _ADR: Address
                        {
                            Return (^^^^IGPU.DD03._ADR ())
                        }

                        Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
                        {
                            Return (^^^^IGPU.DD03._DCS ())
                        }

                        Method (_DGS, 0, NotSerialized)  // _DGS: Display Graphics State
                        {
                            Return (^^^^IGPU.DD03._DGS ())
                        }
                    ...
                    Device (DD04)
                    {
                        Method (_ADR, 0, Serialized)  // _ADR: Address
                        {
                            Return (^^^^IGPU.DD04._ADR ())
                        }

                        Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
                        {
                            Return (^^^^IGPU.DD04._DCS ())
                        }

                        Method (_DGS, 0, NotSerialized)  // _DGS: Display Graphics State
                        {
                            Return (^^^^IGPU.DD04._DGS ())
                        }
                    ...
                    Device (DD05)
                    {
                        Method (_ADR, 0, Serialized)  // _ADR: Address
                        {
                            Return (^^^^IGPU.DD05._ADR ())
                        }

                        Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
                        {
                            Return (^^^^IGPU.DD05._DCS ())
                        }

                        Method (_DGS, 0, NotSerialized)  // _DGS: Display Graphics State
                        {
                            Return (^^^^IGPU.DD05._DGS ())
                        }
                    ...
                    Device (DD06)
                    {
                        Method (_ADR, 0, Serialized)  // _ADR: Address
                        {
                            Return (^^^^IGPU.DD06._ADR ())
                        }

                        Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
                        {
                            Return (^^^^IGPU.DD06._DCS ())
                        }

                        Method (_DGS, 0, NotSerialized)  // _DGS: Display Graphics State
                        {
                            Return (^^^^IGPU.DD06._DGS ())
                        }
                    ...
                    Device (DD07)
                    {
                        Method (_ADR, 0, Serialized)  // _ADR: Address
                        {
                            Return (^^^^IGPU.DD07._ADR ())
                        }

                        Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
                        {
                            Return (^^^^IGPU.DD07._DCS ())
                        }

                        Method (_DGS, 0, NotSerialized)  // _DGS: Display Graphics State
                        {
                            Return (^^^^IGPU.DD07._DGS ())
                        }
                    ...
                    Device (DD08)
                    {
                        Method (_ADR, 0, Serialized)  // _ADR: Address
                        {
                            Return (^^^^IGPU.DD08._ADR ())
                        }

                        Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
                        {
                            Return (^^^^IGPU.DD08._DCS ())
                        }

                        Method (_DGS, 0, NotSerialized)  // _DGS: Display Graphics State
                        {
                            Return (^^^^IGPU.DD08._DGS ())
                        }
                    ...
                    Method (VSTS, 0, NotSerialized)
                    {
                        ...
                        {
                            If (LEqual (^^^IGPU.CPDL, And (DID1, 0xFFFF)))
                            {
                                Or (GATD, 0x02, GATD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CPDL, And (DID2, 0xFFFF)))
                                {
                                    Or (GATD, One, GATD)
                                }
                            }
                        ...
                        {
                            If (LEqual (^^^IGPU.CPL2, And (DID1, 0xFFFF)))
                            {
                                Or (GATD, 0x02, GATD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CPL2, And (DID2, 0xFFFF)))
                                {
                                    Or (GATD, One, GATD)
                                }
                            }
                        ...
                        {
                            If (LEqual (^^^IGPU.CPL3, And (DID1, 0xFFFF)))
                            {
                                Or (GATD, 0x02, GATD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CPL3, And (DID2, 0xFFFF)))
                                {
                                    Or (GATD, One, GATD)
                                }
                            }
                        ...
                        {
                            If (LEqual (^^^IGPU.CPL4, And (DID1, 0xFFFF)))
                            {
                                Or (GATD, 0x02, GATD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CPL4, And (DID2, 0xFFFF)))
                                {
                                    Or (GATD, One, GATD)
                                }
                            }
                        ...
                        If (LNotEqual (^^^IGPU.CPL5, Zero))
                        {
                            If (LEqual (^^^IGPU.CPL5, And (DID1, 0xFFFF)))
                            {
                                Or (GATD, 0x02, GATD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CPL5, And (DID2, 0xFFFF)))
                                {
                                    Or (GATD, One, GATD)
                                }
                            }
                        ...
                        If (LNotEqual (^^^IGPU.CPL6, Zero))
                        {
                            If (LEqual (^^^IGPU.CPL6, And (DID1, 0xFFFF)))
                            {
                                Or (GATD, 0x02, GATD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CPL6, And (DID2, 0xFFFF)))
                                {
                                    Or (GATD, One, GATD)
                                }
                            }
                        ...
                        If (LNotEqual (^^^IGPU.CPL7, Zero))
                        {
                            If (LEqual (^^^IGPU.CPL7, And (DID1, 0xFFFF)))
                            {
                                Or (GATD, 0x02, GATD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CPL7, And (DID2, 0xFFFF)))
                                {
                                    Or (GATD, One, GATD)
                                }
                            }
                        ...
                        If (LNotEqual (^^^IGPU.CPL8, Zero))
                        {
                            If (LEqual (^^^IGPU.CPL8, And (DID1, 0xFFFF)))
                            {
                                Or (GATD, 0x02, GATD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CPL8, And (DID2, 0xFFFF)))
                                {
                                    Or (GATD, One, GATD)
                                }
                            }
                        ...
                        {
                            If (LEqual (^^^IGPU.CADL, And (DID1, 0xFFFF)))
                            {
                                Or (GACD, 0x02, GACD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CADL, And (DID2, 0xFFFF)))
                                {
                                    Or (GACD, One, GACD)
                                }
                            }
                        ...
                        {
                            If (LEqual (^^^IGPU.CAL2, And (DID1, 0xFFFF)))
                            {
                                Or (GACD, 0x02, GACD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CAL2, And (DID2, 0xFFFF)))
                                {
                                    Or (GACD, One, GACD)
                                }
                            }
                        ...
                        {
                            If (LEqual (^^^IGPU.CAL3, And (DID1, 0xFFFF)))
                            {
                                Or (GACD, 0x02, GACD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CAL3, And (DID2, 0xFFFF)))
                                {
                                    Or (GACD, One, GACD)
                                }
                            }
                        ...
                        {
                            If (LEqual (^^^IGPU.CAL4, And (DID1, 0xFFFF)))
                            {
                                Or (GACD, 0x02, GACD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CAL4, And (DID2, 0xFFFF)))
                                {
                                    Or (GACD, One, GACD)
                                }
                            }
                        ...
                        If (LNotEqual (^^^IGPU.CAL5, Zero))
                        {
                            If (LEqual (^^^IGPU.CAL5, And (DID1, 0xFFFF)))
                            {
                                Or (GACD, 0x02, GACD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CAL5, And (DID2, 0xFFFF)))
                                {
                                    Or (GACD, One, GACD)
                                }
                            }
                        ...
                        If (LNotEqual (^^^IGPU.CAL6, Zero))
                        {
                            If (LEqual (^^^IGPU.CAL6, And (DID1, 0xFFFF)))
                            {
                                Or (GACD, 0x02, GACD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CAL6, And (DID2, 0xFFFF)))
                                {
                                    Or (GACD, One, GACD)
                                }
                            }
                        ...
                        If (LNotEqual (^^^IGPU.CAL7, Zero))
                        {
                            If (LEqual (^^^IGPU.CAL7, And (DID1, 0xFFFF)))
                            {
                                Or (GACD, 0x02, GACD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CAL7, And (DID2, 0xFFFF)))
                                {
                                    Or (GACD, One, GACD)
                                }
                            }
                        ...
                        If (LNotEqual (^^^IGPU.CAL8, Zero))
                        {
                            If (LEqual (^^^IGPU.CAL8, And (DID1, 0xFFFF)))
                            {
                                Or (GACD, 0x02, GACD)
                            }
                            Else
                            {
                                If (LEqual (^^^IGPU.CAL8, And (DID2, 0xFFFF)))
                                {
                                    Or (GACD, One, GACD)
                                }
                            }
                    ...
                    Method (GETD, 2, Serialized)
                    {
                        ...
                        While (One)
                        {
                            Store (ToInteger (MADL), T_0)
                            If (LEqual (T_0, 0x07))
                            {
                                While (One)
                                {
                                    Store (ToInteger (MSTE), T_1)
                                    If (LEqual (T_1, One))
                                    {
                                        Store (One, CTOI)
                                        Store (0x02, NTOI)
    ...
    OperationRegion (MDBG, SystemMemory, 0x9AFA7018, 0x1004)
